<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RegistrationForm2.aspx.cs" Inherits="Day2.WebApps.RegistrationForm2" %>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="mt-2">
                        <asp:HyperLink ID="link1" runat="server" NavigateUrl="~/WebForm1.aspx">Go to Page 2</asp:HyperLink>
                    </div>
                </div>
                <div class="col-md-3">
